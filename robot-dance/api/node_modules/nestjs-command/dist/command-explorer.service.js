...
let CommandExplorerService = class CommandExplorerService {
    ...
    explore() {
        ...
        return lodash_compact_1.default(lodash_flattendeep_1.default(components.map(component => [...component.values()].map(({ instance, metatype }) => this.filterCommands(instance, metatype)))));
    }
