...
const createCommandParamDecorator = (paramtype) => {
    return (option) => (target, key, index) => {
        ...
        Reflect.defineMetadata(exports.COMMAND_ARGS_METADATA, Object.assign(Object.assign({}, params), { [paramtype]: [...(params[paramtype] || []), { index, option }] }), target[key]);
    };
};
function Command(option) {
    return (target, key, descriptor) => {
        ...
        common_1.SetMetadata(exports.COMMAND_HANDLER_METADATA, metadata)(target, key, descriptor);
    };
}
